...
public class PotionsMenu extends AbstractMenu {
    ...
    protected void build() {
        ...
        inv.setItem(4,  makeItem(Material.GOLDEN_PICKAXE, 1, "§5Haste II - 15 DP",  "§aHaste II for 2 minutes"));
        inv.setItem(13, makeItem(Material.GOLDEN_PICKAXE, 2, "§5Haste II - 30 DP", "§aHaste II for 4 minutes"));
        inv.setItem(22, makeItem(Material.GOLDEN_PICKAXE, 3, "§5Haste II - 50 DP", "§aHaste II for 6 minutes"));
